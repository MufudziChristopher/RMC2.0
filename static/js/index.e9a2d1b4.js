...
class l {
	...
	fx1() {
		...
		this.clearCells();
		const e = (o, s, i = 0) => {
			s.cache = s.state, 44 === i ? (s.set(s.original), ++t, t === this.totalChars && (this.isAnimating = !1)) : 0 === s.position ? s.set(i < 9 ? ["*", "-", "'", '"'][Math.floor(4 * Math.random())] : this.getRandomChar()) : s.set(o.cells[s.previousCellPosition].cache), "&nbsp;" != s.cache && ++i, i < 45 && setTimeout((() => e(o, s, i)), 15)
		};
		for(const t of this.lines)
